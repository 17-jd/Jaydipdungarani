...
const Contact = () => {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    window.location.href = `mailto:dungarani.j@northeastern.edu?subject=Portfolio Contact from ${name}&body=${encodeURIComponent(message)}`
    setSent(true)
  }
        ...
        <div className="contact-inner">
          <div className={`reveal ${inView ? 'visible' : ''} d1`}>
            ...
            <div className="contact-links">
              ...
              <a className="contact-link" style={{ cursor: 'default' }}>
                <MdLocationOn />
                Boston, MA
              </a>
            </div>
